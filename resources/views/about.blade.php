    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <h1 class="text-center mb-4 text-primary-color">About MediCore</h1>
                        <p class="lead">MediCore is a comprehensive medical management system designed to streamline healthcare operations and improve patient care.</p>
                        
                        <h3>Our Mission</h3>
                        <p>To provide healthcare professionals with efficient tools for managing patients, appointments, medicines, and administrative tasks.</p>
